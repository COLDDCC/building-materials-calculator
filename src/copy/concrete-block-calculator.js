export default {
  ...
  formula: {
    lines: [
      ...
      'Mortar bags    = ceil( Blocks ÷ 27 )        (8 in block, 80 lb bag)',
    ...
    body: [
      ...
      'Mortar comes out of block count, not area. One 80 lb bag of Type N or S mortar mix lays about 27 standard 8 in blocks, because the bed and head joints scale with the width of the block face you are buttering. Narrower 4 in block gets roughly 54 blocks per bag; 12 in block drops to about 18. Each bag also needs around 25 lb of masonry sand if you are mixing from Portland rather than buying premixed.',
  ...
  example: {
    ...
    steps: [
      ...
      ['Mortar', '189 ÷ 27 = 7 bags (80 lb)'],
      ['Sand', '7 bags × 25 lb ≈ 0.09 tons'],
    ],
    conclusion:
      'Order 189 blocks and seven bags of mortar. Had you measured the actual 15⅝ in block face instead, the same wall would have come out at 203 blocks — fourteen extra blocks and one extra pallet charge for a wall that cannot use them.',
  },
  ...
  tables: [
    ...
    },
    {
      ...
      rows: [
        ['4 in', '2 bags', '50 lb', '0.37 cu yd'],
        ['6 in', '3 bags', '75 lb', '0.74 cu yd'],
        ['8 in', '4 bags', '100 lb', '1.04 cu yd'],
        ['12 in', '6 bags', '150 lb', '1.67 cu yd'],
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Roughly 27 standard 8 in blocks per 80 lb bag with a 3/8 in joint. That drops if your joints run thick or your blocks are wider, and rises for narrow partition block. Buy one spare bag on any job over about 200 blocks — running short mid-course is worse than having one left over.',
    },
    {
